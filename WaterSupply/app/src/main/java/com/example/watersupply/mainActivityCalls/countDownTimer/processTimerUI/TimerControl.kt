...
fun MainActivity.initTimer() {
    timerFunctionality.timerState = PrefUtil.getTimerState(this)
...
fun MainActivity.resetTimer(){
    ...
    setNewTimerLength()
    PrefUtil.setSecondsRemaining(timerFunctionality.timerLengthSeconds, this)
...
fun MainActivity.setPreviousTimerLength() {
    ...
    timerFunctionality.timerLengthSeconds = PrefUtil.getPreviousTimerLengthSeconds(this)
...
fun MainActivity.updateCountdownUI() {
    ...
    clock_view.text = timeLeftFormatted
